...
<div class="container position-relative my-2">
    ...
    <div class="box box-primary">
            ...
            action="{{url('post-update-investasi', $investasi->id)}}">
             @csrf
              <div class="box-body">
                <div class="form-group">
                <label for="name">Nama Investasi</label>
                <input type="text" class="form-control" id="name" name="name" value="{{$investasi->name}}" placeholder="{{$investasi->name}}">
                </div>

                <div class="form-group">
                <label for="price">Harga</label>
                <input type="number" class="form-control" name="price" value="{{$investasi->price}}" id="price" placeholder="{{$investasi->price}}">
                </div>

                <div class="form-group">
                <label for="asal">Periode kontrak</label>
                <input type="text" class="form-control" name="kontrak" id="asal" value="{{$investasi->kontrak}}" placeholder="{{$investasi->kontrak}}">
                </div>

                <div class="form-group">
                <label for="asal">Hasil</label>
                <input type="text" class="form-control" name="hasil" id="asal" value="{{$investasi->hasil}}" placeholder="{{$investasi->hasil}}">
                </div>

                <div class="form-group">
                <label for="asal">Bagi Hasil</label>
                <input type="text" class="form-control" name="bagi" id="asal" value="{{$investasi->bagi}}" placeholder="{{$investasi->bagi}}">
                </div>

                <div class="form-group">
                <label for="stock">unit tersisa</label>
                <input type="number" class="form-control" id="unit" name="unit" value="{{$investasi->unit}}" placeholder="{{$investasi->unit}}">
                </div>

                <div class="form-group">
                  <label for="image-input">Masukan Gambar</label>
                  <input type="file" class="form-control-file" name="image" value="{{$investasi->img_path}}">
                </div>  
              </div>
